...
public class OfficerRegisController {
    ...
    private void approveOfficerRegisMenu() {
        ...
        BTOFileService.editBTOByColumn(targetProject.getProjectName(), FileManifest.PROJECT_COLUMNS.PENDING_OFFICERS,
            targetProject.getAppliedOfficers().stream().map(Officer::getName).collect(Collectors.joining(",")),false);
        BTOFileService.editBTOByColumn(targetProject.getProjectName(), FileManifest.PROJECT_COLUMNS.APPROVED_OFFICERS,
    ...
    private void rejectOfficerRegisMenu() {
        ...
        BTOFileService.editBTOByColumn(targetProject.getProjectName(), FileManifest.PROJECT_COLUMNS.PENDING_OFFICERS,
            targetProject.getAppliedOfficers().stream().map(Officer::getName).collect(Collectors.joining(",")),false);
        BTOFileService.editBTOByColumn(targetProject.getProjectName(), FileManifest.PROJECT_COLUMNS.REJECTED_OFFICERS,
